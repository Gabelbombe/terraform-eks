...
# The actual environments (like sandbox) just inject their environment dependent
# values to env-def which defines the actual environment and creates that environment using given values.

# NOTE: You need the EKS cluster name to be known already when creating VPC
